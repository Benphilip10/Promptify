...
//function to handle copying of prompts
const handleCopy = () => {
...

      {
        ...
        && (
            <div className="mt-5 flex-end gap-5 border-t border-gray-300 pt-3">
              <p className="text-sm font-inter cursor-pointer green_gradient"
              onClick={handleEdit}
              >
                Edit
              </p>
              <p className="text-sm font-inter cursor-pointer orange_gradient"
